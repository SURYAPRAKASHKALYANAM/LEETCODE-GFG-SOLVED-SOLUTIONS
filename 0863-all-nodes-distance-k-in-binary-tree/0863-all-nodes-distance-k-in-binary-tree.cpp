...
class Solution
{
    ...
    {
       	//         find parent to each node 
        map<TreeNode*, TreeNode*> parent;
        pre(root, parent);
       	//         traverse radially in all directions maintaing visited map and a queue until distance is k from target
       	//         to move top use parent ,to go down use left and right
        int dis = 0;
